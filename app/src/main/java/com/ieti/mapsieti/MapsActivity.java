...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onActivityResult(int requestCode , int resultCode, Intent data) {
        ...
        String[] datos = (String[]) data.getSerializableExtra("info");
        LatLng myLocation = new LatLng( Double.parseDouble(datos[0]), Double.parseDouble(datos[1]));
        googleMap.addMarker( new MarkerOptions().position( myLocation ).title( "Add Location" ) );
    }
        ...
        fusedLocationClient.getLastLocation()
                .addOnSuccessListener(this, location -> {
                    if ( location != null )
                    {
                        ...
                        System.out.println("addddddddrrr "+ this.address);
